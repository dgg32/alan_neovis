...
const configuration = new Configuration({
  apiKey: "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"
});
...
class DoctorAI extends Component {
  ...
  callDoctorAI() {
    ...
    const alan = localStorage.getItem("alan")

    let search = steps.user.value;
    if (alan === null) {

    }
    else {
      search = alan;
      localStorage.setItem("alan", null)
    }
    
    console.log("search", search, "alan", alan);
